...
const  BProfile= () => {
    return (<>
        ...
        <Button href="/buddy-home"><img src={h}className="E-11-s" alt="" /></Button> 
   <Button href="/buddy-profile">  <img src={c} className="E-11-t" alt=""/></Button> 
    <Button href="/buddy-setting"> <img src={s} className="E-11-u" alt=""/></Button>
    ...
    <div className="E-13-box2">
      ...
      <div className="E-13-product-section">
        ...
        <Button href="./buddy-home"  className="E-13-btn1" type="submit"> Update</Button>
        <Button href="./buddy-home"  className="E-13-btn2" type="submit"> Back</Button>
        <Button href="./buddy-account-type-change"  className="E-13-btn3" type="submit"> Change Account Type</Button>
    </div></>
    );
};

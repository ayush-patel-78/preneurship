        ...
        <div className="E-6-container1">
            ...
            <div className="E-6-main-box">
                <div className="E-6-box1">
                    ...
                    <label className="E-6-pancard" >Pan card <span>*</span></label> <br></br>
                    {/* <h5>Pan card <span>*</span></h5> */}
                    {/* <h2>Pan Card</h2> */}
                    <input type="file" accept=".jpg, .jpeg, .png" /> <br />
                    <div className="E-6-btn2"><Link style={{color: 'white',textDecoration:'none'}} to="">Need time to verify </Link> </div>
                    {/* <Link  to="">Need </Link> <br /> <br></br> */}
                    <br></br>
                    <Link className="E-6-btn1" to="./investor-overview" type="submit" >Next &#62;</Link>
                </div>
                <div className="E-6-box2"><img src={i} alt="" /></div>
            </div>
        </div></>
    );
};

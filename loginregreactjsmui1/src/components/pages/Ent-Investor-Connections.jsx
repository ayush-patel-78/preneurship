    ...
    <div className="E-17-container">
      ...
      <div className="E-17-box2">
        <div className="E-17-row">
            ...
            <Link to="./investor-messages"className="E-17-btn3"  type="submit">Messages <span>+</span></Link>
                <Link to="./investor-connections"className="E-17-btn2"  type="submit">Connections</Link>
            ...
            <Link className="E-17-btn1" to="./investor-home" type="submit">Next &#62;</Link> 
        </div>
    </div>

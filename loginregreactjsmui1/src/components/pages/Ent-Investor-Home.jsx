...
const IHome = () => {
  return (<>
    <div className="E-14-navbar2">
      <Link to="/investor-home"> <img src={h} className="E-14-s" alt="" /></Link>
      <Link to="/investor-profile"> <img src={c} className="E-11-t" alt="" /></Link>
      <Link to="/investor-portfolio">  <img src={s} className="E-11-u" alt="" /></Link>



    </div>
    <div className="E-14-container1">
      <div className="E-14-navbar"> <span>
        <h5>John dept</h5>
        <p>Ozone pvt. ltd</p>
        <Link to="./investor-messages" className="E-14-notification "> <span>Inbox</span>
    ...
    <div className="E-14-box2">
      ...
      <input type="text" placeholder="Company Valuation" name="" id="" /> <br />

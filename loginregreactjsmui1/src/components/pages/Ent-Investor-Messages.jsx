      ...
      <div className="E-16-box2">
        <div className="E-16-row">
            <div className="E-16-col-6">
                <Link to="./investor-messages"className="E-16-btn2"  type="submit">Messages</Link>
                <Link to="./investor-connections"className="E-16-btn3"  type="submit">Connections <span>+</span></Link>
            ...
            <Link to="./investor-home"className="E-16-btn1"  type="submit"> &#60; Back </Link>
        </div>
    </div>

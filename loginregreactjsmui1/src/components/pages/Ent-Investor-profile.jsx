...
const  IProfile= () => {
    ...
    <div className="E-15-container1">
      <div className="E-15-navbar"> <span>
          <h5>John dept</h5>
          <p>Ozone pvt. ltd</p>
        </span> </div>
       ...
       <div className="E-15-box2">
        ...
        <input type="text" name="" id="" placeholder="Company description"/> <br/>
        ...
        <Link to="./investor-home"  className="E-15-btn1" type="submit"> Update</Link>
        <Link to="./investor-account-type-change"  className="E-15-btn2" type="submit"> Change Account Type</Link> <br></br><br></br>

        <Link to="./investor-home"  className="E-15-btn3" type="submit">&#60; Back</Link>

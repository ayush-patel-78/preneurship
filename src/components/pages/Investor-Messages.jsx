      ...
      <div className="E-16-box2">
        <div className="E-16-row">
            <div className="E-16-col-6">
                <Button href="./investor-messages"className="E-16-btn2"  type="submit">Messages</Button>
                <Button href="./investor-connections"className="E-16-btn3"  type="submit">Connections <span>+</span></Button>
            ...
            <Button href="./investor-home"className="E-16-btn1"  type="submit"> &#60; Back </Button>
        </div>
    </div>
